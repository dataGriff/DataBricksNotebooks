...
# MAGIC 
# MAGIC Apache Spark&trade; and Azure Databricks&reg; allow you to use DataFrames to query large data files.
# MAGIC 
...
# MAGIC ## Next Steps
# MAGIC 
# MAGIC Start the next lesson, [Exploratory Data Analysis]($./02-Exploratory-Data-Analysis).

...
# MAGIC 
# MAGIC Identify the problems Apache Spark&trade; and Azure Databricks&reg; are well suited to solve. This includes the types of tasks well-suited to Apache Spark’s Unified Analytics Engine, as well as examples of tasks not well-suited for Apache Spark.
...
# MAGIC **A:** See the document <a href="https://docs.azuredatabricks.net/user-guide/dbfs-databricks-file-system.html#dbfs" target="_blank">Databricks File System - DBFS</a>.
# MAGIC 

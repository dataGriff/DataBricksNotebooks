...
# MAGIC     var allHints = document.getElementsByClassName("hint-9363");
# MAGIC     var answer = document.getElementById("answer-9363");
...
# MAGIC     }
# MAGIC 
# MAGIC     var button = document.getElementById("hint-button-9363");
...
# MAGIC           id="hint-button-9363">Click here for a hint</button>
# MAGIC </div>
# MAGIC <div id="answer-9363" style="padding-bottom: 20px; display: none">
# MAGIC   The answer:
...
# MAGIC <script type="text/javascript">
# MAGIC   window.onload = function() {
# MAGIC     var allHints = document.getElementsByClassName("hint-8205");
# MAGIC     var answer = document.getElementById("answer-8205");
# MAGIC     var totalHints = allHints.length;
# MAGIC     var nextHint = 0;
# MAGIC     var hasAnswer = (answer != null);
# MAGIC     var items = new Array();
...
# MAGIC     }
# MAGIC 
# MAGIC     var button = document.getElementById("hint-button-8205");
# MAGIC     if (totalHints == 0) {
# MAGIC       button.innerHTML = answerLabel;
# MAGIC     }
# MAGIC     button.onclick = function() {
...
# MAGIC   <button type="button" class="btn btn-light"
# MAGIC           style="margin-top: 1em"
# MAGIC           id="hint-button-8205">Click here for a hint</button>
# MAGIC </div>
# MAGIC <div id="answer-8205" style="padding-bottom: 20px; display: none">
# MAGIC   The answer:
# MAGIC   <div class="answer" style="margin-left: 1em">
...
# MAGIC <script type="text/javascript">
# MAGIC   window.onload = function() {
# MAGIC     var allHints = document.getElementsByClassName("hint-9125");
# MAGIC     var answer = document.getElementById("answer-9125");
# MAGIC     var totalHints = allHints.length;
# MAGIC     var nextHint = 0;
# MAGIC     var hasAnswer = (answer != null);
# MAGIC     var items = new Array();
...
# MAGIC     }
# MAGIC 
# MAGIC     var button = document.getElementById("hint-button-9125");
# MAGIC     if (totalHints == 0) {
# MAGIC       button.innerHTML = answerLabel;
# MAGIC     }
# MAGIC     button.onclick = function() {
...
# MAGIC   <button type="button" class="btn btn-light"
# MAGIC           style="margin-top: 1em"
# MAGIC           id="hint-button-9125">Click here for a hint</button>
# MAGIC </div>
# MAGIC <div id="answer-9125" style="padding-bottom: 20px; display: none">
# MAGIC   The answer:
# MAGIC   <div class="answer" style="margin-left: 1em">
...
# MAGIC <script type="text/javascript">
# MAGIC   window.onload = function() {
# MAGIC     var allHints = document.getElementsByClassName("hint-4219");
# MAGIC     var answer = document.getElementById("answer-4219");
# MAGIC     var totalHints = allHints.length;
# MAGIC     var nextHint = 0;
# MAGIC     var hasAnswer = (answer != null);
# MAGIC     var items = new Array();
...
# MAGIC     }
# MAGIC 
# MAGIC     var button = document.getElementById("hint-button-4219");
# MAGIC     if (totalHints == 0) {
# MAGIC       button.innerHTML = answerLabel;
# MAGIC     }
# MAGIC     button.onclick = function() {
...
# MAGIC   <button type="button" class="btn btn-light"
# MAGIC           style="margin-top: 1em"
# MAGIC           id="hint-button-4219">Click here for a hint</button>
# MAGIC </div>
# MAGIC <div id="answer-4219" style="padding-bottom: 20px; display: none">
# MAGIC   The answer:
# MAGIC   <div class="answer" style="margin-left: 1em">
...
# MAGIC 
# MAGIC As we did in the previous lesson, we are going to specify the stream's name so that we can have better control over it.
...
# MAGIC %md
# MAGIC Before proceeding, we need to stop any streams
...
# MAGIC <script type="text/javascript">
# MAGIC   window.onload = function() {
# MAGIC     var allHints = document.getElementsByClassName("hint-9942");
# MAGIC     var answer = document.getElementById("answer-9942");
# MAGIC     var totalHints = allHints.length;
# MAGIC     var nextHint = 0;
# MAGIC     var hasAnswer = (answer != null);
# MAGIC     var items = new Array();
...
# MAGIC     }
# MAGIC 
# MAGIC     var button = document.getElementById("hint-button-9942");
# MAGIC     if (totalHints == 0) {
# MAGIC       button.innerHTML = answerLabel;
# MAGIC     }
# MAGIC     button.onclick = function() {
...
# MAGIC   <button type="button" class="btn btn-light"
# MAGIC           style="margin-top: 1em"
# MAGIC           id="hint-button-9942">Click here for a hint</button>
# MAGIC </div>
# MAGIC <div id="answer-9942" style="padding-bottom: 20px; display: none">
# MAGIC   The answer:
# MAGIC   <div class="answer" style="margin-left: 1em">

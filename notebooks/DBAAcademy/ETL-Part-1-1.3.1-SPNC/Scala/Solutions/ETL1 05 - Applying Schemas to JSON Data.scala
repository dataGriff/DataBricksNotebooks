...
dbTest("ET1-S-05-01-02", true, sample.contains("12-9-2013 21:30:02"))

dbTest("ET1-P-05-01-03", true, cols.contains("Location"))
dbTest("ET1-P-05-01-04", true, cols.contains("SMS"))
dbTest("ET1-P-05-01-05", true, cols.contains("WiFi"))
dbTest("ET1-P-05-01-06", true, cols.contains("_corrupt_record"))
dbTest("ET1-P-05-01-07", true, cols.contains("Application"))
dbTest("ET1-P-05-01-08", true, cols.contains("Call"))
dbTest("ET1-P-05-01-09", true, cols.contains("Bluetooth"))

...
dbTest("ET1-S-02-01-03", true, cols.contains("count"))
dbTest("ET1-S-02-01-03", true, cols.contains("ip"))
...
// ANSWER
val writePath = workingDir + "/ipCount.parquet"
...
val ipCount2 = ipCount(1).asInstanceOf[Long]
val cols = ipCountDF2.columns

dbTest("ET1-S-02-02-01", "213.152.28.bhe", ipCount(0))
dbTest("ET1-S-02-02-02", true, ipCount2 > 500000 && ipCount2 < 550000)
dbTest("ET1-S-02-02-03", true, cols.contains("count"))
dbTest("ET1-S-02-02-04", true, cols.contains("ip"))

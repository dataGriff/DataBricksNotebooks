...
dupedWithColsDF = (dupedDF
                   .withColumn("lcFirstName", lower("firstName"))
                   .withColumn("lcMiddleName", lower("middleName"))
                   .withColumn("lcLastName", lower("lastName"))
                   .withColumn("ssnNums", regexp_replace("ssn","-","")))
...
columns_to_drop = ['lcFirstName', 'lcMiddleName','lcLastName','ssnNums']

dedupedDF = dupedWithColsDF.dropDuplicates(columns_to_drop).drop(*columns_to_drop)
...
# MAGIC ## Next Steps
# MAGIC 
# MAGIC Start the next lesson, [User Defined Functions]($./ETL2 03 - User Defined Functions ).

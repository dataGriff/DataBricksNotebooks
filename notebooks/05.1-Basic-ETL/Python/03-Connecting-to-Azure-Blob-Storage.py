...
# MAGIC 
# MAGIC Apache Spark&trade; and Azure Databricks&reg; allow you to connect to virtually any data store including Azure Blob Storage.
...
# MAGIC **Answer:** By mounting it. Mounts require Azure credentials such as SAS keys and give access to a virtually infinite store for your data. One other option is to define your keys in a single notebook that only you have permission to access. Click the arrow next to a notebook in the Workspace tab to define access permisions.
# MAGIC 
